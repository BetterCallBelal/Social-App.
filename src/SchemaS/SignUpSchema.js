...
export let schema= zod.object({
  name : zod.string().nonempty('Name is required').min(3 , 'Min 3 Letters').max(20 , 'Max 8 Letters') ,
  username : zod.string().nonempty('Username is required').min(3 , 'Min 3 Letters').max(20 , 'Max 8 Letters') ,
